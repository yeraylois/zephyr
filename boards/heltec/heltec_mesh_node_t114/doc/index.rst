...
The board can be flashed using an external debugger via the SWD connector,
or using the on-board UF2 bootloader.

Base target
-----------

Build the Zephyr kernel and the :zephyr:code-sample:`blinky` sample
application for the base target:

.. zephyr-app-commands::
   :zephyr-app: samples/basic/blinky
   :board: heltec_mesh_node_t114/nrf52840
   :goals: build
   :compact:

Flash using a debugger:
